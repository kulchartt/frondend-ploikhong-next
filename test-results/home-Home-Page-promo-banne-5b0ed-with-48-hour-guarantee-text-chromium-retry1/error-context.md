...
- Name: home.spec.ts >> Home Page >> promo banner: visible with 48-hour guarantee text
- Location: e2e\home.spec.ts:36:7
...
Locator: getByText(/48 ชม/)
Expected: visible
Error: strict mode violation: getByText(/48 ชม/) resolved to 2 elements:
    1) <div>ขายของชิ้นแรกได้ใน 48 ชม. — การันตี</div> aka getByText('ขายของชิ้นแรกได้ใน 48')
    2) <div>ดันโพสต์ขึ้นฟีดบนสุด 48 ชม. เพิ่มยอดคนเห็น 8-12 เ…</div> aka getByText('ดันโพสต์ขึ้นฟีดบนสุด 48')

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByText(/48 ชม/)
