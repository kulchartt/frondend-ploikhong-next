...
function TabCoins() {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
      ...
      <StepCard n={3} icon={<IconCard />} title="ชำระผ่าน Omise" desc="รองรับหลายช่องทาง" items={['บัตรเครดิต / เดบิต (Visa, Mastercard) — 3-D Secure', 'PromptPay — สแกน QR Code', 'Mobile Banking — เร็วๆ นี้']} />
