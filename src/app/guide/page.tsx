...
function TabBuyer() {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
      <StepCard n={1} icon={<IconUser />} title="สมัครสมาชิก / เข้าสู่ระบบ" desc="สร้างบัญชีฟรี ใช้เวลาไม่ถึง 1 นาที" items={['กดปุ่ม "เข้าสู่ระบบ" ที่มุมขวาบนของหน้าเว็บ', 'สมัครด้วย Google หรืออีเมล + รหัสผ่าน', 'ยืนยันอีเมลแล้วเริ่มใช้งานได้ทันที']} />
...
function TabSeller() {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
      <StepCard n={1} icon={<IconUser />} title="สมัครสมาชิก" desc="บัญชีเดียวใช้ได้ทั้งซื้อและขาย ฟรีตลอด" items={['สมัครด้วย Google หรืออีเมล', 'ไม่มีค่าธรรมเนียมสมัคร ไม่มีค่าลงประกาศ', 'ลงขายได้ไม่จำกัดจำนวนสินค้า']} />
